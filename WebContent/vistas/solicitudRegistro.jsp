...
<section class="container">
	<div class="row">
		<form class="form-horizontal" method="post"
			action="${pageContext.request.contextPath}/RegistrarSolicitud">
			<fieldset>
				...
				<div class="col-lg-9">
					<div class="form-group">
						...
						<div class="col-lg-4">
							<input name="SOL_CI" type="text" class="form-control" id="CI"
								placeholder="CI" pattern="^[0-9]*$" required
								title="Solo se admiten numeros." pattern=".{10,10}" required
								title="Longitud incorrecta.">
						</div>
						<label for="nombre" class="col-lg-2 control-label">Teléfono</label>
						<div class="col-lg-4">
							<input required name="SOL_TELEFONO" type="text"
					...
					<div class="form-group">
						...
						<div class="col-lg-4">
							<select required name="SOL_CODPROV" class="form-control"
								id="Provincia">
						...
						<div class="col-lg-4">
							<select required name="SOL_CODCIU" class="form-control"
								id="Ciudad">
					...
					<div class="form-group">
						...
						<label for="nombre" class="col-lg-2 control-label">Número
							de miembros del hogar</label>
						<div class="col-lg-4">
							<input required name="SOL_NUMMIEM" type="text"
								class="form-control" id="numeroMiembros"
								placeholder="numeroMiembros" pattern="^[0-9]*$"
					...
					<div class="form-group">
						...
						<label class="col-lg-2 control-label">Algún miembro tiene
							discapacidad</label>
						<div class="col-lg-4">
							<div class="radio">
